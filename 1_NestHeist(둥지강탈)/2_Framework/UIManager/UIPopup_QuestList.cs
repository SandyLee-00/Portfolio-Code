...
public class UIPopup_QuestList : UIPopup
{
    ...
    public void SetButton(Action OnExit, Action OnQuestTest)
    {
        ExitButton.onClick.AddListener(() => { OnExit(); OnUIClickSound(); });
        QuestTestButton.onClick.AddListener(() => { OnQuestTest(); OnUIClickSound(); });
    }
...
public class UIPopup_QuestList_Presenter : Presenter
{
    ...
    {
        _view.SetButton(Exit, QuestTest);
    }
